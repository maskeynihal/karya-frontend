...
var createProject = function createProject(user) {
...
var showProject = function showProject(userId) {
...
var editProject = function editProject(userId, user) {
...
var showProjectSuccess = function showProjectSuccess(user) {
  return {
...
var createProjectSuccess = function createProjectSuccess(user) {
  return {
...
var editProjectSuccess = function editProjectSuccess(user) {
  return {
